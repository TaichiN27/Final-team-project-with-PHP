...
<body>
  ...
  <div id="leftSideMenu">
    ...
    <button type="button" class="navLink" id="logo">BINARY BEAST</button>
      <a href="<?php echo $_SERVER['PHP_SELF'] . '?addr=student_main' ?>" class="navLink" role="tab" aria-selected="true" id="showDashboard">
        <img src="../icons/dashboard.png" class="menuIcon" />STUDENT DASHBOARD
      </a>
      <a href="<?php echo $_SERVER['PHP_SELF'] . '?addr=enrollment' ?>" class="navLink" role="tab" aria-selected="false" id="showUiElements">
        <img src="../icons/uiElements.png" class="menuIcon" />ENROLL IN COURSE </a>
      <a href="<?php echo $_SERVER['PHP_SELF'] . '?addr=stu_marks' ?>" class="navLink" role="tab" aria-selected="false" id="showTabsPanel">
        <img src="../icons/uiElements.png" class="menuIcon" />MARK & COMMENT</a>
    </nav>
  </div>
